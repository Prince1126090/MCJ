...
//			
	...
	public String PreviewBill() throws Exception{
		...
		try {	
			...
			if(this.report_type.equals("0"))status=new Paragraph(" (Non Approved bills)", font3);
			if(this.report_type.equals("1"))status=new Paragraph(" (Approved and Unpaid bills)", font3);
			if(this.report_type.equals("2"))status=new Paragraph(" (Collected bills)", font3);
			
			if(getReport_for().equals("area_wise")){
				
				Chunk chunk8 = new Chunk("Preview of Monthly Bill for ",font2);
				Chunk chunk9 = new Chunk(String.valueOf(Area.values()[Integer.valueOf(getArea_id())-1]),font3);
				...
				Chunk chunk4 = new Chunk(String.valueOf(getCategory_name()),font1);
