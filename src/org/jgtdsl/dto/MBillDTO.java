...
public class MBillDTO {
	...
	private ArrayList<PreviewTotalDTO> previewTotalist;
 
	public ArrayList<PreviewTotalDTO> getPreviewTotalist() {
		return previewTotalist;
	}

	public void setPreviewTotalist(ArrayList<PreviewTotalDTO> previewTotalist) {
		this.previewTotalist = previewTotalist;
	}
